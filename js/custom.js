...
POTENZA.raindrops = function () {
  if ($('.raindrops').exists()) {
     loadScript(plugin_path + 'raindrops/raindrops.js', function() {
         $('#raindrops').raindrops({color:'#0079fc',
         canvasHeight:50});
     });
    }
};
...
activeBtn.addEventListener('click',function(){
	...
	document.cookie = "CookieBy=SchoonenMeer; expires=" + new Date(2025,0,1).toUTCString();
	//This cookies expires after 30 days
	document.cookie = "Name=; max-age=" + 60*60*24*30;
	document.cookie = "LastName=; max-age=" + 60*60*24*30;
